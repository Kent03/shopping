	...
	<div class=" main-content-area">
		...
		<div class="wrap-iten-in-cart">
			...
			<div class="alert alert-success">
				<Strong>Thông báo</Strong> {{Session::get('success_message')}}
			</div>
			@endif
		...
		<div class="summary">
		<div class="update-cleared " style="float:right">
				<a class="btn btn-clear" href="#"wire:click.prevent="destroyAll()"> <i class="fa fa-times-circle" aria-hidden="true"></i> Xóa tất cả</a>
				<a class="btn btn-update" href="#"><i class="fa fa-spinner" aria-hidden="true"></i> Cập nhật tất cả</a>
			</div>
