	...
	<div class="row">
		...
		<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
					...
					<ul class="our-services">
						...
						<li class="service">
							<a class="link-to-service" href="#">
								...
								<div class="right-content">
									...
									<span class="subtitle">Đơn hàng từ 99k</span>
									<p class="desc">Giao hàng toàn quốc 64 tỉnh thành...</p>
								</div>
							</a>
						</li>
						...
						<li class="service">
							<a class="link-to-service" href="#">
								...
								<div class="right-content">
									<b class="title">Mua là có quà</b>
									<span class="subtitle">Get a gift!</span>
									<p class="desc">Nhanh chóng mua hàng để săn quà hấp dẫn...</p>
								</div>
							</a>
						</li>
						...
						<li class="service">
							<a class="link-to-service" href="#">
								...
								<div class="right-content">
									<b class="title">Đổi trả lên đến 7 ngày</b>
									<span class="subtitle">Đổi mới nếu lỗi trong vòng 7 ngày</span>
			...
			<div class="widget mercado-widget widget-product">
				<h2 class="widget-title">Những sản phẩm phổ biến</h2>
				<div class="widget-content">
					<ul class="products">
		...
		<div class="single-advance-box col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="wrap-show-advance-info-box style-1 box-in-site">
				<h3 class="title-box">Sản phẩm tương tự nên xem</h3>
